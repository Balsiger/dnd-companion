...
public class FakeData extends Data {
  ...
  public FakeData(String nickName, String appId, FakeDataBaseAccessor dataBaseAccessor) {
    super(dataBaseAccessor);

    // The order of initialization here is important, as settings are used for the rest of the data.
