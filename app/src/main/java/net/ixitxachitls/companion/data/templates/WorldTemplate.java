...
public class WorldTemplate extends StoredTemplate<Template.WorldTemplateProto> {
  ...
  public static net.ixitxachitls.companion.proto.Template.WorldTemplateProto defaultProto() {
    return net.ixitxachitls.companion.proto.Template.WorldTemplateProto.getDefaultInstance();
  }

  public static WorldTemplate fromProto(net.ixitxachitls.companion.proto.Template.WorldTemplateProto proto) {
