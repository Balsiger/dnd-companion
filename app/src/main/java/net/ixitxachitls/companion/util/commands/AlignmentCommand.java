 ...
 */
public class AlignmentCommand extends TextCommand {
  private final Layout.Alignment alignment;

  public AlignmentCommand(Layout.Alignment alignment) {
  ...
  public Spanned render(RenderingContext context, List<SpannableStringBuilder> optionals,
    ...
    arguments.get(0).setSpan(new AlignmentSpan.Standard(alignment),
