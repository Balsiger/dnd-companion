...
public class Conditions {
  ...
  public static ImmutableList<Condition> CONDITIONS = new ImmutableList.Builder<Condition>()
      .add(Condition.newBuilder("Ability Damaged")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Ability Drained")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Blinded")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Blown Away")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Checked")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Confused")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Cowering")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Dazed")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Dazzled")
      ...
      .add(Condition.newBuilder("Dead")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Deafened")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Disabled")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Dying")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Energy Drained")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Entangled")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Exhausted")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Fascinated")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Fatigued")
          ...
          .build())
      .add(FLAT_FOOTED)
      .add(Condition.newBuilder("Frightened")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Grappling")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Helpless")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Incorporeal")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Invisible")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Knocked Down")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Nauseated")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Panicked")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Paralyzed")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Petrified")
      ...
      .add(Condition.newBuilder("Prone")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Shaken")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Sickened")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Stable")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Staggered")
          .description("A character whose nonlethal damage exactly equals his current hit points "
              ...
              + "unconscious.")
          .summary("Nonlethal equal current hp, single move or standrd action only.")
          .predefined()
          .build())
      .add(Condition.newBuilder("Stunned")
          ...
          .build())
      .add(SURPRISED)
      .add(Condition.newBuilder("Turned")
          ...
          .predefined()
          .build())
      .add(Condition.newBuilder("Unconscious")
